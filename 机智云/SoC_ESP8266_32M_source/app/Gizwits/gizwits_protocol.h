...
* @{
*/
#define PRODUCT_KEY "257c469afd69449a8cd991d0244681fd"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "a39f48ebe8d1464f9b0647d0efa5ddf4"
...
* @{
*/
#define LED_C_BYTEOFFSET                    0
#define LED_C_BITOFFSET                     0
#define LED_C_LEN                           2
